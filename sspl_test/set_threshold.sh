...
then
    ...
    /opt/seagate/$PRODUCT/hare/bin/consul kv put sspl/config/NODEDATAMSGHANDLER/transmit_interval $transmit_interval
fi
...
then
    ...
    /opt/seagate/$PRODUCT/hare/bin/consul kv put sspl/config/NODEDATAMSGHANDLER/disk_usage_threshold $out
fi
...
then
    ...
    /opt/seagate/$PRODUCT/hare/bin/consul kv put sspl/config/NODEDATAMSGHANDLER/host_memory_usage_threshold $host_out
fi
...
then
    ...
    /opt/seagate/$PRODUCT/hare/bin/consul kv put sspl/config/NODEDATAMSGHANDLER/cpu_usage_threshold $cpu_out
fi