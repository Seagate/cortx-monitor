...
def test_real_stor_disk_actuator(agrs):
    ...
    for disk_actuator_specific_info in disk_actuator_specific_infos:
        ...
        assert(disk_actuator_specific_info.get("LED-status".lower()) is not None)
        assert(disk_actuator_specific_info.get("locator-LED".lower()) is not None)
        ...
        #assert(disk_actuator_specific_info.get("enclosure-family") is not None)
