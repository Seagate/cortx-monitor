...
from cortx.sspl.sspl_test.generate_test_report import generate_html_report
from cortx.sspl.sspl_test.common import (TestFailed, init_rabbitMQ_msg_processors,
...
def tmain(argp, argv):
    ...
    for ts in ts_list:
        ...
        try:
            ts_module = __import__('cortx.sspl.sspl_test.%s' %ts, fromlist=[ts])
            # Initialization
