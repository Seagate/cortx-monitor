...
class RealStorSideplaneActuatorTest(TestCaseBase):
    ...
    def response(self, msg):
        sideplane_module_actuator_msg = msg.get("actuator_response_type")
        ...
        if resource_id == "*":
            self.verify_sideplane_module_specific_info(sideplane_specific_info)
            return
    ...
    def verify_sideplane_module_specific_info(self, sideplane_specific_info):
...
test_list = [RealStorSideplaneActuatorTest]
