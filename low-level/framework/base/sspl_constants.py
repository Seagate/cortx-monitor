...
SSPL_SERVICE_FILE = "%s/conf/%s" % (SSPL_BASE_DIR, SERVICE_NAME)
...
sspl_testv2_file_path = "%s/sspl_test/functional_tests/v2/conf/sspl_tests.conf" % (SSPL_BASE_DIR)
...
sspl_testv2_config_path = "%s://%s" % (CONFIG_SPEC_TYPE, sspl_testv2_file_path)
