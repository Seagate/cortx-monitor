...
sspl_newtest_file_path = "%s/sspl_test/functional_tests/conf/sspl_tests.conf" % (SSPL_BASE_DIR)
...
sspl_newtest_config_path = "%s://%s" % (CONFIG_SPEC_TYPE, sspl_newtest_file_path)
