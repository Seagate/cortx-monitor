 ...
 ****************************************************************************
  Description:       Defines the JSON message transmitted by the
                    RealStorEnclMsgHandler for changes in health of Disk Group
  ****************************************************************************
"""
...
class RealStorDiskGroupDataMsg(BaseSensorMsg):
    '''
    The JSON message transmitted by the Service Watchdogs
    '''

    SENSOR_RESPONSE_TYPE = "enclosure_disk_group_alert"
    ...
    def __init__(self, host_name,
        ...
        super(RealStorDiskGroupDataMsg, self).__init__()
