        ...
        try:
            ...
            if isinstance(err, ConnectionError):
                ...
                if url.find(self.LOOPBACK) == -1:
                    print("Connection Error for ws api {0} - {1}"\
                        .format(url,err))
                ...
                if url.find(self.LOOPBACK) == -1:
                    print("HTTP Error encountered for api {0} - {1}"\
                        .format(url,err))
                ...
                if url.find(self.LOOPBACK) == -1:
                    print("Timeout for api {0} - {1}".format(url,err))
                ...
                if url.find(self.LOOPBACK) == -1:
                    print("Error encountered for api {0} - {1}"\
                        ", defaulting to err {2}"\
