...
class SetupYumRepo:
    ...
    def _validate_centos_release_support(self):
        ...
        if "CentOS Linux release 7.9" in content:
            self.url_local_repo_commons="%s/third-party-deps/centos/centos-7.9.2009/" % (CORTX_BASE_URL)
            self.url_uploads_repo = "%s/uploads/centos/centos-7.9.2009/" % (CORTX_BASE_URL)
