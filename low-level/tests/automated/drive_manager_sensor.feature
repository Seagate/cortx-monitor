...
Scenario: Change 10 drives to inuse_failed status and examine all responses
	Given that all drives are set to "inuse_ok" and sspl is started
	When I set "10" drives to "inuse_failed"
	Then SSPL_LL transmits JSON msgs with status "inuse_failed" for "10" drives for enclosure "SHU0951732G1GXC"

Scenario: Change 10 drives to inuse_ok status and examine all responses
	Given that all drives are set to "inuse_failed" and sspl is started
	When I set "10" drives to "inuse_ok"
	Then SSPL_LL transmits JSON msgs with status "inuse_ok" for "10" drives for enclosure "SHU0951732G1GXC"
