...
Scenario: Ungracefully halt the running crond service with SIGINT and verify the watchdog transmits correct json msg
	Given that the "crond" service is "running" and SSPL_LL is running
	When I ungracefully halt the "crond" service with signal "2"
	Then I receive a service watchdog json msg with service name "crond.service" and state of "inactive"
...
Scenario: Stop the dcs-collector service and verify the watchdog transmits correct json msg
	...
	Then I receive a service watchdog json msg with service name "dcs-collector.service" and state of "deactivating"
...
Scenario: Start the dcs-collector service and verify the watchdog transmits correct json msg
	...
	Then I receive a service watchdog json msg with service name "dcs-collector.service" and state of "activating"