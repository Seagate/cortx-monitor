                ...
                if result == "failed":
                    ...
                    if os.path.exists(fault_status_file):
                        ...
                        if self.FAULT_RESOLVED in data:
                            ...
                            self._alert_msg = "Inconsistency detected in the RAID disk data, for %s RAID-1 array." %device
                ...
                if os.path.exists(fault_status_file):
                    ...
                    if self.FAULT in data:
                        ...
                        if device == faulty_device:
                            ...
                            self._alert_msg = "Data inconsistency detected in %s RAID-1 array is resolved." %device
                            self._send_json_msg(self.alert_type, device, self._alert_msg)
