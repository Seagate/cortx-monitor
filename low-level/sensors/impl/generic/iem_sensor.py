...
class IEMSensor(SensorThread, InternalMsgQ):
    ...
    DEFAULT_LOG_FILE_PATH = f"/var/log/{PRODUCT_NAME}/iem/iem_messages"
    DEFAULT_TIMESTAMP_FILE_PATH = f"/var/{PRODUCT_NAME}/sspl/data/iem/last_processed_msg_time"
    DEFAULT_SITE_ID = "001"
    DEFAULT_RACK_ID = "001"
    DEFAULT_NODE_ID = "001"
    ...
    IEC_MAPPING_DIR_PATH=f"/opt/seagate/{PRODUCT_NAME}/iem/iec_mapping"
